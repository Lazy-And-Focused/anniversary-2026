...
export const RANKS: Rank[] = [
  ...
  {
    name: "❤️ Лафер",
    description: "О, приветствую, участник команды, а если ты не он, то можешь написать нам и мы рассмотрим твоё заявление",
    moreThan: 0.9,
    lessThan: 1
  }
];
...
. К слову, LotTop уже не в команде, а aculaOne сменил псевдоним на lanvalird",
  ...
  },
  {
    ...
    answer: "2024",
    explanation: "Команда была собрана по частично случайно. Нам нужна была новая независящая от экосистемы The Void команда, так и потихоньку двигались, это происходило на Discord сервере The Void Community",
    options: [
      "2021",
      "2022",
      "2023",
  ...
  },
  {
    ...
    answer: "LotTop",
    explanation: "Он ничего не делал в команде, так же почти никак не развивался в сторону программирования",
    options: [
      "aculaOne",
      "lanvalird",
      "FOCKUSTY",
  ...
  },
  {
    ...
    explanation: "LAF и love созвучны, так стандартная фраза \"От меня с любовью\" превратилась в наш девиз",
    options: [
      "From LAF with love",
  ...
  },
  {
    ...
    answer: "FOCKUSTY",
    explanation: "FOCKUSTY — CEO и основатель команды, Discord сервер принадлежит ему, там и была основана команда",
    options: [
      "FOCKUSTY",
      "lanvalird",
      "aculaOne",
  ...
  },
  {
    ...
    answer: "Нужно было упростить разработку приложения, чтобы писать меньше шаблонного кода, архитектура предоставляет всё из коробки, после неё остаётся написать только логику",
    explanation: {
  ...
  },
  {
    ...
    explanation: {
      ...
      detailedLink: "https://github.com/Lazy-And-Focused/BAD-Architecture/blob/main/docs/intoduction.md"
    },
    options: [
...
const summarizeScores = (scores: "correct"|"wrong") => {
  return Object.keys(QUESTIONS).map(key => QUESTIONS[key].scores[scores]).reduce((p, c) => p+c);
}
